...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        can_create_expert_observation = Permission.objects.get(codename=UserPermissions.CAN_CREATE_EXPERT_OBSERVATION, content_type=content_type)

        # Assign permissions to groups
        admin_group.permissions.add(can_generate_invitation, can_invite_admins, can_invite_group_leaders, can_create_expert_observation)
